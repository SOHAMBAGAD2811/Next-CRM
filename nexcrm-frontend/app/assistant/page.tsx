...
export default function AssistantPage() {
  ...
  return (
    <>
      ...
      <div className="page" style={{ display: 'grid', gridTemplateColumns: '1fr 260px', gap: 20, height: 'calc(100vh - 56px - 40px)', padding: 20 }}>

        {/* Chat */}
        <div className="panel" style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
          {/* Messages */}
          <div style={{ flex: 1, overflowY: 'auto', padding: 20, display: 'flex', flexDirection: 'column', gap: 16, background: '#ece9e2' }}>
            {messages.map((msg, i) => (
          ...
          {/* Input */}
          <div className="chat-input-row" style={{ borderTop: 'var(--border)' }}>
            <textarea
